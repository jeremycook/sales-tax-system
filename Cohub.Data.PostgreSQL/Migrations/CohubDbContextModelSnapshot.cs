...
namespace Cohub.Data.PostgreSQL.Migrations
{
    ...
    partial class CohubDbContextModelSnapshot : ModelSnapshot
    {
        protected override void BuildModel(ModelBuilder modelBuilder)
        {
#pragma warning disable 612, 618
            modelBuilder
                .HasDefaultSchema("sts")
            ...
            modelBuilder.Entity("Cohub.Data.Fin.PaymentConfiguration", b =>
                {
                    ...
                    b.ToTable("payment_configuration", "sts");
                });
            ...
            modelBuilder.Entity("Cohub.Data.Fin.StatementComment", b =>
                {
                    ...
                    b.ToTable("statement_comment", "sts");
                });
            ...
            modelBuilder.Entity("Cohub.Data.Fin.StatementDue", b =>
                {
                    ...
                    b.Property<decimal>("TotalOverpayment")
                        .HasColumnType("numeric")
                        .HasColumnName("total_overpayment");
            ...
            modelBuilder.Entity("Cohub.Data.Fin.StatementReasonCode", b =>
                {
                    ...
                    b.ToTable("statement_reason_code", "sts");
                });
            ...
            modelBuilder.Entity("Cohub.Data.Fin.TransactionDetail", b =>
                {
                    ...
                    b.ToTable("transaction_detail", "sts");
                });
            ...
            modelBuilder.Entity("Cohub.Data.Lic.License", b =>
                {
                    ...
                    b.ToTable("license", "sts");
                });

            modelBuilder.Entity("Cohub.Data.Lic.LicenseSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<DateTime>("CurrentBusinessLicenseExpirationDate")
                        .HasColumnType("date")
                        .HasColumnName("current_business_license_expiration_date");

                    b.Property<DateTime>("NextBusinessLicenseExpirationDate")
                        .HasColumnType("date")
                        .HasColumnName("next_business_license_expiration_date");

                    b.HasKey("Id");

                    b.HasIndex("CreatedById");

                    b.ToTable("license_settings", "sts");
                });
            ...
            modelBuilder.Entity("Cohub.Data.Org.Organization", b =>
                {
                    ...
                    b.Property<bool>("OnlineFiler")
                        .HasColumnType("boolean")
                        .HasColumnName("online_filer");
                    ...
                    b.Property<bool>("SendPhysicalMail")
                        .HasColumnType("boolean")
                        .HasColumnName("send_physical_mail");
            ...
            modelBuilder.Entity("Cohub.Data.Org.OrganizationClassification", b =>
                {
                    ...
                    b.ToTable("organization_classification", "sts");
                });
            ...
            modelBuilder.Entity("Cohub.Data.Org.OrganizationComment", b =>
                {
                    ...
                    b.ToTable("organization_comment", "sts");
                });
            ...
            modelBuilder.Entity("Cohub.Data.Org.OrganizationContact", b =>
                {
                    ...
                    b.ToTable("organization_contact", "sts");
                });
            ...
            modelBuilder.Entity("Cohub.Data.Org.OrganizationLabel", b =>
                {
                    ...
                    b.ToTable("organization_label", "sts");
                });
            ...
            modelBuilder.Entity("Cohub.Data.Org.OrganizationStatus", b =>
                {
                    ...
                    b.ToTable("organization_status", "sts");
                });
            ...
            modelBuilder.Entity("Cohub.Data.Org.OrganizationType", b =>
                {
                    ...
                    b.ToTable("organization_type", "sts");
                });
            ...
            modelBuilder.Entity("Cohub.Data.Usr.Comment", b =>
                {
                    ...
                    b.HasIndex("IsUserComment");

                    b.ToTable("comment", "sts");
                });
